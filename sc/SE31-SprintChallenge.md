...
It's important to ensure consistent style and sufficient commenting so that the code can be read by anyone else independently, without the help of the initial coder. It ensures that although the code might be the contribution of many different individuals, the style remains "neutral".

Other reasons are to catch mistakes and make the code more efficient, thus increasing code performance.

I pay attention to clarity of code, ensuring sufficient commenting.

What I value most from reviewing code is learning better ways of doing things I already know how to do, and also learn new coding methods or libraries.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us improve this situation?

It allows an application to run on any computer without worrying about dependancies or the OS that a coder is using. This makes it much easier to collaborate in teams where everyone has a different workflow, system upgrades and dependencies (or lack of). 
